...
<head>
    ...
    <link href="<?= base_url('public/assets-admin'); ?>/vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
        type="text/css">
    <link
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="<?= base_url('public/gambar'); ?>/undraw_profile.svg">
                            </a>
                    ...
                    <div class="d-flex align-items-center justify-content-between small">
                        <row>
                            <div class="text-muted">&copy;
                                ...
                                BANDA TOUR MAP, All Right Reserved
                            </div>
                        </row>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="exampleModalLabel">Yakin ingin Logout?</h5>
